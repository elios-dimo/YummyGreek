  ...
  dishes: [
    {
      ...
      price: 15.99,
      image: 'https://placehold.co/400x300?text=Moussaka',
      ingredients: [
    ...
    },
    {
      ...
      name: 'Greek Salad',
      description:
        "Greek Salad is a fresh and vibrant dish featuring a colorful medley of ingredients, including ripe tomatoes, crisp cucumbers, Kalamata olives, and creamy feta cheese. It's a perfect choice for a light and healthy meal. This classic salad bursts with Mediterranean flavors and is known for its simplicity and freshness.",
      price: 10.99,
    ...
    },
    {
      ...
      name: 'Spanakopita',
      description:
        "Spanakopita is a delightful Greek pastry made of flaky filo dough filled with a savory mixture of spinach, feta cheese, and aromatic herbs. Baked to golden perfection, this dish is known for its crispiness and savory filling. It's a favorite appetizer or snack in Greek cuisine.",
      price: 9.99,
      image: 'https://placehold.co/400x300?text=Spanakopita',
      ingredients: [
        'Flaky filo dough',
        'Spinach',
        'Feta cheese',
    ...
    },
    {
      ...
      name: 'Dolmades',
      description:
        'Dolmades are a Mediterranean delight, featuring grape leaves stuffed with seasoned rice and aromatic herbs, served with a drizzle of lemon sauce. These bite-sized parcels are bursting with flavor and are often enjoyed as an appetizer or part of a meze platter.',
      price: 8.99,
      image: 'https://placehold.co/400x300?text=Dolmades',
      ingredients: [
        'Grape leaves',
        'Seasoned rice',
        'Aromatic herbs',
    ...
    },
    {
      ...
      price: 14.99,
      image: 'https://placehold.co/400x300?text=Mediterranean+Pasta',
      ingredients: [
        'Pasta',
        'Sun-dried tomatoes',
        'Kalamata olives',
    ...
    },
    {
      ...
      description:
        "Grilled Octopus is a seafood delicacy known for its tender and smoky flavor. It's prepared by grilling octopus until it's charred and served with a drizzle of lemon and olive oil. This dish is a must-try for seafood enthusiasts looking to savor the taste of the Mediterranean.",
      price: 18.99,
